...
io.on('connection', async clientSocket => {
    ...
    clientSocket.on('nuevoUsuario', async usuario => {
        // Con broadcast en envia el mensaje a todos, excepto al que envio el mensje
        clientSocket.broadcast.emit('nuevoUsuario', usuario)
